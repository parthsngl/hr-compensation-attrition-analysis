...
2. **Who is at risk of leaving — and is it the *right* people?** — engagement & risk scoring.
3. **If we had to cut compensation cost, where could we cut with the least damage?** — bottom-20% workforce optimization simulation.
4. **What actually drives attrition at IBM?** — interpretable logistic-regression model with feature importance.

The full analysis lives in the Jupyter notebook (exported to PDF in [`reports/`](reports/)), and the headline visuals are reproduced inline below.
...
<details>
<summary><b>📂 Click to expand: full column descriptions</b></summary>
...
> 💡 **Insight:** R&D dominates headcount, but income is driven by **JobLevel**, not department. Almost everyone above $15K/month is JobLevel 4–5.

---

### 2. Compensation Analysis — Compa-Ratio & Pay Bands

For each employee we compute a **Compa-Ratio** = `MonthlyIncome / median(MonthlyIncome | JobRole, JobLevel)`. A Compa-Ratio of 1.00 means "exactly what the role typically pays." We then bucket employees into pay bands (Below / In / Above band) and look at distribution across departments and tenure.
...
> 💡 **Insight:** **219 employees sit *below* their pay band** and **549 sit *above* it** — inconsistent calibration across the board. Tenure barely correlates with Compa-Ratio, meaning long-tenured staff are not being systematically rewarded.
...
> 💡 **Insight:** **HR carries the largest unfavorable gap of −14.0%** for women vs men, despite HR being the most female-heavy department.

---

### 4. Engagement & Risk Scoring

Each employee receives a composite **risk score** built from JobInvolvement, JobSatisfaction, EnvironmentSatisfaction, WorkLifeBalance, OverTime and YearsSinceLastPromotion. Scores are bucketed into action plans (Monitor / Engage / Intervene / Urgent) and mapped against department.
...
> 💡 **Insight:** **14 employees fall into the "high-priority retention" bucket** — small enough that an HRBP can personally reach out to every one this quarter.

---

### 5. Workforce Optimization Simulation

If leadership *had* to reduce compensation cost, the data-driven play is to target the **bottom-20% by a composite of PerformanceRating, JobInvolvement, engagement and Compa-Ratio**, then simulate a controlled reduction. We compare the selected cohort against the overall workforce to confirm we're not cutting top talent by accident.
...
> 💡 **Insight:** The bottom-20% pool contains **294 employees**. Removing them delivers a **~19% reduction in monthly payroll — roughly $1.82M/month** while leaving top performance and engagement deciles untouched.

---

### 6. Logistic Regression Attrition Model

A logistic regression is trained on the engineered feature set (Compa-Ratio, JobInvolvement, OverTime, JobSatisfaction, YearsAtCompany, etc.) with a stratified train/test split. Logistic regression was chosen for **interpretability** — the goal is not just prediction, but telling HR *which levers to pull*.
...
> 💡 **Insight:** The two most actionable attrition levers are **fair pay** and **job involvement** — both directly controllable by management.
...
├── reports/
│   ├── IBM_Attrition_python_v1.pdf
│   └── IBM_Attrition_python_v2.pdf
├── requirements.txt
└── README.md
```
...
# 4a. Read the analysis (PDF)
open reports/IBM_Attrition_python_v2.pdf

# 4b. Re-run interactively
jupyter notebook
```

Load the dataset in one line:
...
<table>
<tr>
<td align="center" width="33%"><img src="images/01_gender_distribution_across_departments.png" width="280"/><br/><sub><b>01.</b> Gender distribution across departments</sub></td>
<td align="center" width="33%"><img src="images/02_monthly_income_distribution_analysis.png" width="280"/><br/><sub><b>02.</b> Monthly income distribution (skew = 1.37)</sub></td>
<td align="center" width="33%"><img src="images/03_monthly_income_where_employees_stand.png" width="280"/><br/><sub><b>03.</b> Where each employee stands on the income curve</sub></td>
</tr>
<tr>
<td align="center"><img src="images/04_compa_ratio_by_department.png" width="280"/><br/><sub><b>04.</b> Compa-Ratio by department</sub></td>
<td align="center"><img src="images/05_compa_ratio_pay_band_distribution.png" width="280"/><br/><sub><b>05.</b> Pay-band distribution (below / in / above)</sub></td>
<td align="center"><img src="images/06_average_salary_by_gender_and_department.png" width="280"/><br/><sub><b>06.</b> Average salary by gender and department</sub></td>
</tr>
<tr>
<td align="center"><img src="images/07_pay_band_outliers_heatmap.png" width="280"/><br/><sub><b>07.</b> Pay-band outlier heatmap</sub></td>
<td align="center"><img src="images/08_compa_ratio_vs_tenure_scatter.png" width="280"/><br/><sub><b>08.</b> Compa-Ratio vs tenure</sub></td>
<td align="center"><img src="images/09_engagement_action_plan_distribution.png" width="280"/><br/><sub><b>09.</b> Engagement action-plan distribution</sub></td>
</tr>
<tr>
<td align="center"><img src="images/10_engagement_plan_by_department.png" width="280"/><br/><sub><b>10.</b> Engagement plan by department</sub></td>
<td align="center"><img src="images/11_engagement_risk_heatmap.png" width="280"/><br/><sub><b>11.</b> Engagement risk heatmap</sub></td>
<td align="center"><img src="images/12_risk_score_distribution_with_cutoff.png" width="280"/><br/><sub><b>12.</b> Risk-score distribution with cutoff</sub></td>
</tr>
<tr>
<td align="center"><img src="images/13_bottom_20pct_workforce_by_department.png" width="280"/><br/><sub><b>13.</b> Bottom-20% workforce by department</sub></td>
<td align="center"><img src="images/14_performance_distribution_selected_vs_overall.png" width="280"/><br/><sub><b>14.</b> Performance: selected vs overall</sub></td>
<td align="center"><img src="images/15_engagement_comparison_all_vs_bottom20.png" width="280"/><br/><sub><b>15.</b> Engagement: all vs bottom-20%</sub></td>
</tr>
<tr>
<td align="center"><img src="images/16_feature_importance_attrition_drivers.png" width="280"/><br/><sub><b>16.</b> Feature importance — attrition drivers</sub></td>
<td align="center"><img src="images/17_compensation_cost_reduction_target_analysis.png" width="280"/><br/><sub><b>17.</b> Compensation cost-reduction target</sub></td>
<td align="center"><img src="images/18_workforce_reduction_bottom20_identification.png" width="280"/><br/><sub><b>18.</b> Workforce-reduction identification</sub></td>
</tr>
<tr>
<td align="center"><img src="images/19_salary_distribution_after_cut_cost_impact.png" width="280"/><br/><sub><b>19.</b> Salary distribution after cut</sub></td>
<td align="center"><img src="images/20_who_gets_flagged_for_exit.png" width="280"/><br/><sub><b>20.</b> Who gets flagged for exit</sub></td>
<td align="center"></td>
</tr>
</table>
...
- **Boosted-tree models** — train XGBoost / LightGBM and benchmark against the logistic baseline on AUC and minority-class recall.
- **SHAP explainability** — replace coefficient-based importance with SHAP values for per-employee "why is this person at risk?" narratives.
...
- **Causal uplift modeling** — estimate which employees would actually *respond* to a retention intervention, not just who's at risk.
